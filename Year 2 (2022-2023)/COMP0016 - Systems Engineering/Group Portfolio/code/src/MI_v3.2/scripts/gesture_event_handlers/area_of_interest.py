'''
Authors: Carmen Meinson and Oluwaponmile Femi-Sunmaila
...
class AreaOfInterest:
    ...
    def convert_xy_fps(self, x_cam_percent: float, y_cam_percent: float) -> Tuple[float, float]:
        """Does an affine transformation for camera x,y coordinates to map to the screen pixels"""
        x, y = (
        ...
        yNew = yNew - (self._screen_height - int(GetSystemMetrics(1)))

        xNew = xNew - (self._screen_width - int(GetSystemMetrics(0)))
