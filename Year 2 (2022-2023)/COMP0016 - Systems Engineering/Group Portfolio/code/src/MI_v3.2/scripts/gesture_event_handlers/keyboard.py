'''
Author:
Contributors: Siam Islam, Keyur Narotomo, Anelia Gaydardzhieva
Comments:
...
class Keyboard:
    ...
    def settings(self) -> None:
        ...
        """
        mode = self.mode_editor.get_data("current_mode")

        base_path = "MI3-%s-3.11-MFC.exe"
        target_path = ""
    ...
    def hotkey_combination(*args) -> None:
        for arg in args:
            # pydirectinput doen't work with the win key
            if arg == "win":
