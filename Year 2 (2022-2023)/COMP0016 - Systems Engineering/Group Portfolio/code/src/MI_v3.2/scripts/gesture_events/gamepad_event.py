...
class GamepadMode1Event(GamepadModeEvent):
    ...
    """
    _gesture_types = {"walking_left_state","walking_right_state", "extremity_left_walking", "extremity_right_walking", "extremity_up_walking", "extremity_down_walking", "extremity_down_button", "extremity_right_button", "extremity_up_button", "extremity_left_button", "extremity_start_key", "extremity_quit_key"}  
    ...
    def set_up(self) -> None:
        ...
        self._event_triggers["set_displays"](["left_walking", "right_walking", "up_walking", "down_walking", "down_button", "right_button", "left_button", "up_button", "start_key", "quit_key"])
...
class GamepadMode3Event(GamepadMode1Event):
    ...
    [gestures types]:
        ...
        "extremity_quit_key": quit key extremity trigger to cause a key down action
    """
    _gesture_types = {"walking_left_state","walking_right_state", "extremity_left_walking", "extremity_right_walking", "extremity_down_walking", "extremity_down_button", "extremity_right_button", "extremity_up_button", "extremity_left_button", "extremity_start_key", "extremity_quit_key"}  
    _event_trigger_types = {"set_displays", "walking_triggered", "extremity_triggered", "held", "walking_released", "extremity_released", "clear"}
    ...
    def set_up(self) -> None:
        ...
        editor = config.get_editor()
        editor.update(f"modules/body/mode", "no_equipment") # change the exercise mode to walking (so if an equipment exercise event was loaded before, we can revert it)
        self._event_triggers["set_displays"](["left_walking", "right_walking", "down_walking", "down_button", "right_button", "left_button", "up_button", "start_key", "quit_key"])